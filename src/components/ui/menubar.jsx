...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-9 items-center space-x-1 rounded-md border border-gray-200 bg-[#171717] p-1 shadow-sm dark:border-gray-800 dark:bg-gray-950",
      className
    )}
    {...props}
  />
...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-none focus:bg-[#28292F] focus:text-white data-[state=open]:bg-[#28292F] data-[state=open]:text-white data-[state=open]:shadow-2xl data-[state=open]:shadow-black dark:focus:bg-gray-800 dark:focus:text-gray-50 dark:data-[state=open]:bg-gray-800 dark:data-[state=open]:text-gray-50",
      className
    )}
    {...props}
  />
